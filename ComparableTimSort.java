...
class ComparableTimSort {
	 ...
	 * sequence length.
	 *
	 * This value is changed precisely for the purpose of allowing test regardless
	 * of the run lengths.
	 */
	//private static final int MIN_MERGE = 32;
	private static final int MIN_MERGE = 1;
	...
	private static int vincent;

	/**
	 * Vincent = 0: MaxGallop = 7 forever.
	 * 
	 * Vincent = 1: MaxGallop increases up to 12 or 13.
	 * 
	 * Vincent = 2: MaxGallop capped at start and increases up to log((a+b)/a).
	 * 
	 * Vincent = 3: MaxGallop uncapped at start, increases up to log((a+b)/a).
	 * 
	 * Vincent = 4: MaxGallop increases arbitrarily
	 */
	 ...
	 * @since 1.8
	 */
	static void sort(Object[] a, int lo, int hi, Object[] work, int workBase, int workLen, int vin) {
	...
	private void mergeLo(int base1, int len1, int base2, int len2) {
		...
		int maxGallop = 20;
		if (vincent == 2 || vincent == 3) {
			int l = len1 + len2;
			for (int l2 = len1; l2 != 0; l2 >>= 1) {
				l >>= 1;
			}
			for (; l != 0; l >>= 1) {
				maxGallop += 2;
		...
		if (vincent == 2 && minGallop > maxGallop) {
			minGallop = maxGallop;
		}
		outer: while (true) {
			...
			do {
				...
				if (vincent != 0)
					minGallop--;
				/*
				 * System.out.println("end gallop:" + minGallop + " at stages " + cursor1 +
				 * " and " + cursor2);
				 */
			} while (count1 >= MIN_GALLOP | count2 >= MIN_GALLOP);
			if (minGallop < 0)
				minGallop = 0;
			/* Next line: new version */
			if (vincent == 4 || (vincent != 0 && minGallop < maxGallop))
				minGallop += 2; // Penalize for leaving gallop mode
			/*
			 * System.out.println("gallop increase:" + minGallop + " at stages " + cursor1 +
			 * " and " + cursor2);
			 */
		} // End of "outer" loop
